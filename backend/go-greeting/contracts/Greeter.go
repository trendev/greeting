...
var GreeterMetaData = &bind.MetaData{
	ABI: "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"writer\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"oldGreeting\",\"type\":\"string\"},{\"indexed\":false,\"internalType\":\"string\",\"name\":\"newGreeting\",\"type\":\"string\"}],\"name\":\"GreetingUpdated\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"stateMutability\":\"nonpayable\",\"type\":\"fallback\"},{\"inputs\":[],\"name\":\"greet\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"a\",\"type\":\"address\"}],\"name\":\"isContract\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"kill\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"greeting\",\"type\":\"string\"}],\"name\":\"setGreeting\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
//
// Solidity: function isContract(address a) view returns(bool)
func (_Greeter *GreeterCaller) IsContract(opts *bind.CallOpts, a common.Address) (bool, error) {
	var out []interface{}
	err := _Greeter.contract.Call(opts, &out, "isContract", a)
...
//
// Solidity: function isContract(address a) view returns(bool)
func (_Greeter *GreeterSession) IsContract(a common.Address) (bool, error) {
	return _Greeter.Contract.IsContract(&_Greeter.CallOpts, a)
}

// IsContract is a free data retrieval call binding the contract method 0x16279055.
//
// Solidity: function isContract(address a) view returns(bool)
func (_Greeter *GreeterCallerSession) IsContract(a common.Address) (bool, error) {
	return _Greeter.Contract.IsContract(&_Greeter.CallOpts, a)
}
...
func (_Greeter *GreeterTransactor) RenounceOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Greeter.contract.Transact(opts, "renounceOwnership")
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Greeter *GreeterSession) RenounceOwnership() (*types.Transaction, error) {
	return _Greeter.Contract.RenounceOwnership(&_Greeter.TransactOpts)
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Greeter *GreeterTransactorSession) RenounceOwnership() (*types.Transaction, error) {
	return _Greeter.Contract.RenounceOwnership(&_Greeter.TransactOpts)
}

// SetGreeting is a paid mutator transaction binding the contract method 0xa4136862.
//
// Solidity: function setGreeting(string greeting) returns()
...
func (_Greeter *GreeterTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _Greeter.contract.Transact(opts, "transferOwnership", newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Greeter *GreeterSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Greeter.Contract.TransferOwnership(&_Greeter.TransactOpts, newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Greeter *GreeterTransactorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Greeter.Contract.TransferOwnership(&_Greeter.TransactOpts, newOwner)
}
...
func (_Greeter *GreeterTransactor) Fallback(opts *bind.TransactOpts, calldata []byte) (*types.Transaction, error) {
	return _Greeter.contract.RawTransact(opts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() returns()
func (_Greeter *GreeterSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _Greeter.Contract.Fallback(&_Greeter.TransactOpts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() returns()
func (_Greeter *GreeterTransactorSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _Greeter.Contract.Fallback(&_Greeter.TransactOpts, calldata)
}
...
//
// Solidity: event GreetingUpdated(address indexed writer, string oldGreeting, string newGreeting)
func (_Greeter *GreeterFilterer) FilterGreetingUpdated(opts *bind.FilterOpts, writer []common.Address) (*GreeterGreetingUpdatedIterator, error) {
	...
	logs, sub, err := _Greeter.contract.FilterLogs(opts, "GreetingUpdated", writerRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event GreetingUpdated(address indexed writer, string oldGreeting, string newGreeting)
func (_Greeter *GreeterFilterer) WatchGreetingUpdated(opts *bind.WatchOpts, sink chan<- *GreeterGreetingUpdated, writer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Greeter.contract.WatchLogs(opts, "GreetingUpdated", writerRule)
	if err != nil {
		return nil, err
	}
...
// GreeterOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the Greeter contract.
type GreeterOwnershipTransferredIterator struct {
	Event *GreeterOwnershipTransferred // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *GreeterOwnershipTransferredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GreeterOwnershipTransferred)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *GreeterOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GreeterOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// GreeterOwnershipTransferred represents a OwnershipTransferred event raised by the Greeter contract.
type GreeterOwnershipTransferred struct {
...
func (_Greeter *GreeterFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*GreeterOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _Greeter.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &GreeterOwnershipTransferredIterator{contract: _Greeter.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Greeter *GreeterFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *GreeterOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Greeter.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(GreeterOwnershipTransferred)
				if err := _Greeter.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Greeter *GreeterFilterer) ParseOwnershipTransferred(log types.Log) (*GreeterOwnershipTransferred, error) {
	event := new(GreeterOwnershipTransferred)
	if err := _Greeter.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
		return nil, err
	}

...
describe('GreeterContractService', () => {
  ...
  //   xit('should fail updating greet (no fund + no gaz fees settings)', (done: DoneFn) => {
  ...
  //   xit('should get the smart contract logs, filtering GreetingUpdated events', (done: DoneFn) => {
  //     from(service.init()).pipe(
